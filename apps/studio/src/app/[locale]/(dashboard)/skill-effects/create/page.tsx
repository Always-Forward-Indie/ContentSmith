...
export default function CreateSkillEffectPage() {
    ...
    const createSkillEffect = trpc.skillEffects.create.useMutation({
        onSuccess: () => {
            toast({
                title: tCommon('success'),
                description: t('skillEffectCreated'),
            });
    ...
    return (
        <div className="max-w-2xl mx-auto space-y-6">
            ...
            <div className="flex items-center gap-4">
                ...
                <h1 className="text-3xl font-bold">{t('createSkillEffect')}</h1>
            </div>

            {/* Форма */}
            <Card>
                <CardHeader>
                    <CardTitle>{t('createSkillEffect')}</CardTitle>
                </CardHeader>
                <CardContent>
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="flex justify-end gap-2 pt-4">
                            ...
                            <Button
                                type="submit"
                                disabled={createSkillEffect.isLoading}
                            >
                                {createSkillEffect.isLoading ? tCommon('loading') : tCommon('create')}
                            </Button>
                        </div>
                    </form>
                </CardContent>
