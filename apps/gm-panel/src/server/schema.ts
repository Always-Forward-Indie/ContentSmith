...
export const characters = pgTable('characters', {
  ...
  totalPlayTimeSec: bigint('total_play_time_sec', { mode: 'number' }).notNull().default(0),
  lastSessionPlayTimeSec: bigint('last_session_play_time_sec', { mode: 'number' }).notNull().default(0),
